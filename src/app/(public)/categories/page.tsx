...
const CATEGORIES = [
	{
		...
		name: "Intro & Outro",
		slug: "intro-outro",
		description: "Eye-catching openers and closers for any video project.",
		icon: "🎬",
		coverImage: null,
	},
	{
		...
		slug: "lower-thirds",
		description:
			"Clean, modern title overlays for interviews and presentations.",
		icon: "🏷️",
		coverImage: null,
	},
	{
		...
		name: "Transitions",
		slug: "transitions",
		description: "Smooth, dynamic transitions to elevate your edits.",
		icon: "🔀",
		coverImage: null,
	},
	{
		...
		name: "Logo Reveals",
		slug: "logo-reveals",
		description: "Cinematic logo animations for brands and studios.",
		icon: "✨",
		coverImage: null,
	},
	{
		...
		name: "Titles & Text",
		slug: "titles-text",
		description: "Animated typography templates for storytelling.",
		icon: "🔤",
		coverImage: null,
	},
	{
		...
		description: "Ready-to-use templates for Reels, Shorts, and Stories.",
		icon: "📱",
		coverImage: null,
	},
];
